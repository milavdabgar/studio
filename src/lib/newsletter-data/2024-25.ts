...
export const newsletterData2024_25: NewsletterData = {
  stats: [
    { label: 'Events', value: 25, color: 'bg-blue-500' },
    { label: 'Industry Visits', value: 6, color: 'bg-green-500' },
    { label: 'Expert Lectures & Workshops', value: 12, color: 'bg-purple-500' },
    { label: 'FDP Participation', value: 5, color: 'bg-orange-500' },
    { label: 'Placements & Higher Education', value: 2, color: 'bg-indigo-500' },
    { label: 'Books, Papers & Patents', value: 0, color: 'bg-red-500' },
    { label: 'Industry Partnerships', value: 15, color: 'bg-teal-500' },
    { label: 'Innovation Projects', value: 35, color: 'bg-amber-500' },
  ],
