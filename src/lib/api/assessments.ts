...
export const assessmentService = {
  ...
  async importAssessments(file: File, courses: Course[], programs: Program[], batches: Batch[]): Promise<{ newCount: number; updatedCount: number; skippedCount: number; errors?: any[] }> {
