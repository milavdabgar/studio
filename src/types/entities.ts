...
export interface Student {
    ...
    createdAt?: Timestamp;
    updatedAt?: Timestamp;
    isActive?: boolean; // This usually comes from the User model
}
...
```
  ...
  <change>
    <file>/src/app/api/enrollments/route.ts</file>
    <content><![CDATA[import { NextResponse, type NextRequest } from 'next/server';
