          ...
          <main className="p-12 space-y-8">
                  ...
                  <div className="flex items-center space-x-4 p-4 bg-gradient-to-br from-purple-50 to-purple-100 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-purple-600">Palanpur, Banaskantha, Gujarat</p>
                        ...
                        <span>Faculty Achievements & Research</span>
                      </div>
                      <div className="flex items-center space-x-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex items-center space-x-2">
                        <span className="text-pink-500">🚀</span>
                        <span>Future Roadmap & Vision 2030</span>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <Card className="export-card">
              <CardHeader>
                ...
                <CardDescription>
                  Choose your preferred format to download the complete newsletter with preserved styling
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    >
                      <CardContent className="p-4">
                        ...
                        <Button 
                          ...
                          size="sm" 
                          className="w-full export-button"
                ...
                <div className="mt-6 p-4 bg-gradient-to-r from-blue-50 to-indigo-50 rounded-lg border border-blue-200">
                  ...
                  <p className="text-blue-800 text-sm">
                    This newsletter features the original beautiful design with gradients, animations, 
                    and sophisticated styling. The <strong>PDF format</strong> preserves all visual 
                    elements for the best reading and printing experience.
                  </p>
                </div>
              </CardContent>
            </Card>
