          ...
          <div className="text-center max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              <div className="text-center">
                ...
                <div className="text-sm text-gray-600">Books Collection</div>
              </div>
              <div className="text-center">
            ...
            <div className="relative">
              <div className="bg-white p-6 rounded-2xl shadow-xl">
                ...
                <div className="mt-6 text-center">
                  ...
                  <p className="text-gray-600">Peaceful environment for focused study and research</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12">
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-6">Library Information</h2>
              ...
              <div className="space-y-4">
                <Card className="p-4 hover:shadow-lg transition-shadow">
                  <Link href="https://gpplibrary.blogspot.com/" target="_blank" rel="noopener noreferrer" 
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900">Library Portal</h3>
                      <p className="text-sm text-gray-600">Access online catalog and e-resources</p>
                    </div>
                ...
                <Card className="p-4 hover:shadow-lg transition-shadow">
                  <Link href="/contact" className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900">Contact Library</h3>
                ...
                <Card className="p-4 hover:shadow-lg transition-shadow">
                  <Link href="/facilities" className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <h3 className="font-semibold text-gray-900">Campus Facilities</h3>
                      <p className="text-sm text-gray-600">Explore other campus facilities</p>
                    </div>
                    <ArrowRight className="h-5 w-5 text-gray-400" />
                  </Link>
                </Card>
