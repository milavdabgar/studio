...
| **Unit-II: Basic Antennas & Arrays**                | 2a. Select antennas and antenna arrays as per their operating frequency ranges and radiation pattern for the specific applications | 2.1 Radiation characteristics of wire antennas: Resonant wire antennas (λ, 2λ), Non Resonant (Rhombic) Antenna<br>2.2 Loop antenna<br>2.3 Folded dipole<br>2.4 Antenna Arrays: Principle of pattern multiplication, Uniform linear array, Broad side array, End fire array<br>2.5 Yagi-uda antenna |
| **Unit-III: Antennas for Special applications**     | 3a. Classify antennas used in HF/VHF/UHF band<br>3b. Understand the working principle of HAM radio<br>3c. Distinguish the modes of operation of HAM radio | 3.1 HF/VHF/UHF antennas: Inverted V Antenna, Helical antenna, Parabolic reflector antenna, Horn antenna<br>3.2 VHF/UHF antennas: Micro strip (patch) antenna, Turnstile and super turnstile antenna, Slot antenna<br>3.3 HAM Radio application for emergency communication: Modes of Propagation, Crystal radio for beginners, Morse code and practise oscillator, Use of digital modes (FT8/PSK/RTTY) in HAM radio |
| **Unit-IV: Wave Propagation**                       | 4a. Describe different modes of wave propagation<br>4b. Explain factors affecting wave propagation<br>4c. Calculate propagation parameters for different frequency bands | 4.1 Ground wave propagation: Surface wave, Space wave<br>4.2 Sky wave propagation: Ionospheric layers, Critical frequency, Maximum usable frequency<br>4.3 Space wave propagation: Line of sight communication, Radio horizon<br>4.4 Factors affecting propagation: Frequency, Time of day, Season, Solar activity |
| **Unit-V: Antennas for Advanced Communication**     | 5a. Describe satellite communication principles<br>5b. Explain antenna systems for satellite communication<br>5c. Understand modern antenna technologies | 5.1 Satellite communication basics: Geostationary satellites, LEO, MEO satellites<br>5.2 Earth station antennas: Parabolic dish antennas, Tracking systems<br>5.3 Modern antenna technologies: Smart antennas, MIMO systems, Phased array antennas<br>5.4 Applications in cellular communication, GPS, and wireless networks |
