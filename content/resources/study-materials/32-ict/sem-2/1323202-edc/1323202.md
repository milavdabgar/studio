...
| **Unit-IV: Integrated Circuits**        | **4a.** Explain characteristics and applications of Op-Amp<br>**4b.** Design and analyze Op-Amp circuits<br>**4c.** Explain working of Timer IC 555<br>**4d.** Design applications using IC 555 | **4.1** Operational Amplifier: characteristics, parameters<br>**4.2** Inverting and Non-inverting amplifiers<br>**4.3** Summing amplifier, Integrator, Differentiator<br>**4.4** Comparator circuits<br>**4.5** Timer IC 555: pin configuration, working<br>**4.6** Monostable, Bistable, and Astable multivibrators using IC 555 |
| **Unit-V: Regulated Power Supply**      | **5a.** Explain need for voltage regulation<br>**5b.** Design voltage regulators using ICs<br>**5c.** Analyze SMPS circuits | **5.1** Need for voltage regulation<br>**5.2** Fixed voltage regulators: 78xx and 79xx series<br>**5.3** Variable voltage regulator: LM317<br>**5.4** Load and line regulation<br>**5.5** SMPS: basic principles and applications |
