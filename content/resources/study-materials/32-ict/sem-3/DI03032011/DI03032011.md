...
| 3 | **Process and Service Management**<br>3.1 Process Management:<br>• Viewing and controlling processes<br>• Background and foreground processes<br>• Commands: ps, top, kill, bg, fg, jobs | 18 | - |

| 3 (cont.) | 3.2 System Services:<br>• Introduction to systemd<br>• Starting, stopping, and enabling services<br>• Commands: systemctl, service, chkconfig (legacy)<br>3.3 Monitoring System Performance:<br>• Tools like top, htop, and free<br>• Log file analysis<br>• Commands: top, htop, free, vmstat, cat, tail, less<br>• Log files: /var/log/syslog, /var/log/messages | | |
...
| 15 | Assess system performance using resource monitoring tools | III | 2 |
| 16 | Interpret system logs for troubleshooting and monitoring | III | 2 |
| 17 | Create and run a basic shell script to automate a task | IV | 2 |
| 18 | Use variables and user input in a script for dynamic behavior | IV | 2 |
| 19 | Apply conditional statements and loops for script logic | IV | 2 |
| 20 | Automate a file backup process using a shell script | IV | 2 |
| 21 | Schedule a script to run automatically using cron | IV | 2 |
| 22 | Partition and format a disk for use in a Linux system | V | 2 |
| 23 | Mount and unmount a file system to manage storage access | V | 2 |
| 24 | Verify and repair file system integrity using diagnostic tools | V | 2 |
| 25 | Configure disk quotas to limit user storage usage | V | 2 |
| 26 | Perform a file backup using archiving and copying tools | V | 2 |
| 27 | Restore files from a backup to recover data | V | 2 |
| | **Total** | | **60** |
