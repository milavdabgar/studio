...
Microprocessor & Microcontroller Systems                                          Course Code: 1333202
...
Information & Communication Technology                          3rd semester
...
the areas of electronics. They include product ranges from tiny consumer electronic products
to complex industrial process controllers. A diploma engineer needs to maintain such systems.
Programming practices will further help the students to develop indigenous microcontroller-
based applications. Hence this course is designed to achieve the system maintenance
...
i.Identify basic features of microprocessor
...
v.Interface microcontroller with hardware for microcontroller-based system
...
- 6     Develop a program to interface a LM35 with 8051                        V       02
                                        Total                                          32
Note
...
Microproce Microcomputer Architecture
               ...
               format                               1.5 Opcode, Operand, Instruction cycle,
...
- 4 to 6 UOs at Application and
                                above level)
                    3 e Describe modes of operation of        3.5 Timers/Counters logic diagram and
                    Timers/Counters, Serial                   its operation in various modes
                    Communication & Interrupt                 3.6 Serial communication modes,
...
Programmi           4 b Define Instruction set of 8051as 4.2 Instruction set: Data Transfer,
ng                  per functions performed              Arithmetic, Logical, Branching, and
...
- 5.3 DAC0808, ADC0804
Microcontr          5 b Interface Output Devices with         5.4 Room Temperature Controller
oller               8051 microcontroller                      System: LM35, ADC0804, Relay
System                                                        5.5 Application of microcontroller in
5 c Interface ADC & DAC with 8051         various field

5 d Interface sensors & actuators
...
- Introduction to Microprocessor                 6    4      4        2          10
- Working of 8085 Microprocessor                 12   8      6        4          18
- Microcontroller Architecture                   8    6      5        5          16
- 8051 Programming                               10   5      6        5          16
- Interfacing & Microcontroller System           6    2      4        4          10
...
1. Develop proficiency in Installation, maintenance and troubleshooting of elesssctronics
and communication systems.
2. Create customized solution of real-life problems using hardware and software.
Semester III                          Microprocessor & Microcontroller Systems
...
of microprocessor                       3           2          2            2              1             2             2       2           3

ii.Explain architecture
and working of                          3           1          2            1              -             2             1       0           1

iii.Illustrate
microcontroller                        3           2          2            3              -             2             3       1           2

internal architecture
iv.Write and execute
assembly language
- 2          2            2              -             2             3       1           3
programs(software)
...
hardware for                           3           3          3            3              1             3             3       2           3
