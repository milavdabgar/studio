...
| 3        | **Inheritance, Interfaces, and Packages**<br>3.1 Implement inheritance in Java programs<br>• Inheritance concepts and types<br>3.2 Apply method overriding and polymorphism<br>• Method overriding principles<br>• Dynamic method dispatch<br>3.3 Create and implement interfaces<br>• Interface definition and implementation<br>• Multiple inheritance through interfaces<br>3.4 Develop abstract classes<br>• Abstract classes and methods<br>3.5 Organize code using packages<br>• Package creation and management<br>• Import statements and access control | 09    | 20            |
| 4        | **Exception Handling and Multithreading**<br>4.1 Implement exception handling in Java applications<br>• Exception handling fundamentals<br>• Exception hierarchy and types<br>• Try, catch, finally blocks<br>4.2 Create custom exceptions<br>• Custom exception creation<br>• Exception handling best practices<br>4.3 Explain multithreading concepts and benefits<br>• Multithreading concepts and benefits<br>• Process vs. Thread<br>• Thread lifecycle and states<br>4.4 Create and manage threads in Java programs<br>• Thread creation approaches<br>• Extending Thread class<br>• Implementing Runnable interface<br />• Thread synchronization and communication | 09    | 20            |
...
- [JavaTpoint - Java Programming Tutorials](https://www.javatpoint.com/java-tutorial)
- [GeeksforGeeks - Java Programming Language](https://www.geeksforgeeks.org/java/)
- [Learn Java Online](https://learnjavaonline.org/)
- [TutorialsPoint - Java Tutorials and Examples](https://www.tutorialspoint.com/java/)

## Video Courses

- [Introduction to Java Programming](https://www.youtube.com/udacity) (Udacity YouTube Playlist)
- [Programming in Java](https://www.youtube.com/nptel) by Debasis Samanta, IIT Kharagpur (NPTEL YouTube Playlist)
- [Java Tutorials For Beginners In Hindi](https://www.youtube.com/codewithharry) (CodeWithHarry YouTube Playlist)

## Comprehensive Courses

- [Java Programming Nanodegree](https://www.udacity.com/) by Udacity
- [Core Java Specialization](https://www.coursera.org/) by LearnQuest on Coursera
- [Java Masterclass 2025: 130+ Hours of Expert Lessons](https://www.udemy.com/) by Tim Bulchka on Udemy
- [Introduction to Object-Oriented Programming with Java](https://www.edx.org/) by Georgia Tech on edX
