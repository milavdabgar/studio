...
| **Unit - II<br>Trigonometry**            | 2a. Apply the concept of Compound angle, Allied angle, and Multiple angles to solve the given simple engineering problem(s)<br>2b. Explain the concept of Sub-Multiple and solve related problem(s)<br>2c. Invoke the concept of Sum and Factor formulae to solve the given simple problem(s)<br>2d. Investigate given simple Trigonometric functions | 2.1 Units of Angles (degree and radian)<br>2.2 Trigonometric Functions<br>2.3 Allied & Compound Angles<br>2.4 Graph of Sine and Cosine<br>2.5 Periodic Trigonometric function<br>2.6 Sum and factor formulae<br>2.7 Inverse Trigonometric function |
...
| ------- | ------------------------------------------------------------ | ------------------------------------ | ----------------------------------- |
| 1       | Dr. N. R. Pandya  I/C Principal (Retired)  Head of Department | Government Polytechnic,  Kheda       | 9099097990                          |
