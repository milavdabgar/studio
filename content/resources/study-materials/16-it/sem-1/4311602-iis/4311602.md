...
| 13 | Identify different aspects of the network in your department lab by following Parameter's consideration.<br>(1) Types of Cables (Twisted-pair, Coaxial, Fiber Optics)<br>(2) Topology (Bus, Mesh, Star, Ring, Hybrid)<br>(3) Network Type (LAN, MAN, WAN) | IV | 02 |

| S. No. | Practical Outcomes (PrOs) | Unit No. | Approx. Hrs. Required |
|--------|---------------------------|----------|----------------------|
| (continued) | (4) Ethernet Cable (Color code, Straight Cable, Cross Cable) | | |
