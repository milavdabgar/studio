...
| S. No. | Practical Outcomes (PrOs) | Unit No. | Approx. Hrs. Required |
|--------|---------------------------|----------|-----------------------|
| 8      | Test and execute Linux file and directory commands to perform following task:<br>a) Display content of file.<br>b) Write a shell script to read two different file names from the command line and copy the content of first file into second file and display suitable message on standard output.<br>c) Write a shell script to search your name from a file and display suitable message.<br>d) Test and execute wc command.<br>e) Write a shell script to accept the string 'diploma in information technology' from user in lower case letter and convert it into upper case letter. Display output with suitable user-friendly message. | III & V  | 02                    |
