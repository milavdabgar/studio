...
| 12        | Import Iris dataset:<br>a. Find rows and columns using shape command<br>b. Print first 30 instances using head command<br>c. Print dataset information using info and describe command<br>d. Find any missing values and print number of missing values<br>e. Plot the univariate graphs(box plot and histograms)<br>f. Plot the multivariate plot(scatter matrix)<br>g. Split data to train model by 80% data values<br>h. Apply K-NN and k means clustering to check accuracy and decide which is better | V        | 06                    |
| **Total** |                                                              |          | **56**                |
