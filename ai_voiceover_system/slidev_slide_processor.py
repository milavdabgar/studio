#!/usr/bin/env python3
"""
Slidev Slide-Level Video Processor
==================================

Creates videos with slide-level narration using actual Slidev exported slides.
Generates one narration segment per slide (no click synchronization).

Uses confirmed voice hierarchy:
...
class SlidevSlideProcessor:
    """Processor for slide-level video generation using actual Slidev exported slides"""
    ...
    def __init__(self, slidev_file):
        ...
        print("🎯 Slidev Slide-Level Video Processor")
        print("📍 One narration segment per slide (no click sync)")
...
def main():
    ...
    if len(sys.argv) < 2:
        ...
        print("💡 Usage: python slidev_slide_processor.py <slidev_file.md> [max_slides]")
        print("💡 Examples:")
        print("   python slidev_slide_processor.py content/slides/my-presentation.md")
        print("   python slidev_slide_processor.py content/slides/my-presentation.md 10")
        print("   python slidev_slide_processor.py ../path/to/slides.md")
        return
    ...
    processor = SlidevSlideProcessor(slidev_file)
