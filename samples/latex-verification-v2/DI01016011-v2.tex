...
\begin{itemize}
\item Python.org
\item Learn Python.org
\item Hackr.io Python Tutorials
\item SoloLearn Python Course
\item NPTEL
\end{itemize}
\end{itemize}
...
\begin{enumerate}
\item {'activity': 'Prepare a document which differentiates python versions.', 'type': 'Research', 'context': "Students should perform following activities in group and prepare reports of about 5 pages for each activity. They should also collect/record physical evidences for their (student's) portfolio which may be useful for their placement interviews."}

\item {'activity': 'Undertake projects in teams', 'type': 'Collaborative Project', 'context': 'Team-based project work to enhance collaboration skills and practical application of learned concepts.'}

\item {'activity': 'Give a seminar on any relevant topics.', 'type': 'Presentation', 'context': 'Individual or group presentations to develop communication skills and deepen understanding of Python-related topics.'}

\item {'activity': 'Undertake a market survey of different python frameworks.', 'type': 'Market Research', 'context': 'Industry analysis to understand current trends and applications of Python frameworks in the market.'}
