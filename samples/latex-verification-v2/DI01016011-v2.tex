...
\begin{document}
\firstpageheader{Diploma in Engineering}{Diploma}{Information Technology}{DI01016011}{Python Programming}


\begin{center}
\begin{tabular}{|l|l|}
\hline
\textbf{w.e.f Academic Year:} & 2024-2025 \\
\hline
\textbf{Semester:} & 1$^{rd}$ \\
\hline
\textbf{Category of the Course:} & PCC \\
\hline
\end{tabular}
\end{center}
...
\hline
\textbf{Prerequisite:} & Basic computer skills, including the ability to write basic statements and expressions. \\
\hline
\end{tabular}
\end{center}
...
\hline
1 & Prepare flowchart and algorithm for solving computing problems. & A \\
\hline
2 & Develop python programs to solve simple problems. & A \\
\hline
3 & Apply control structure feature of python for developing programs. & A \\
\hline
4 & Develop programs in Python using built-in functions, modules, and library functions. & A \\
\hline
5 & Develop python programs applying strings and lists manipulation concepts. & A \\
\hline
\end{tabular}
\end{center}
