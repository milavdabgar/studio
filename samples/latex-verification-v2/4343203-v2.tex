...
\hline
\endhead
CO-a & Write simple java programs for a given problem statement. &  \\
\hline
CO-b & Use object oriented programming concepts to solve real world problems. &  \\
\hline
CO-c & Develop an object-oriented program using inheritance and package concepts for a given problem statement. &  \\
\hline
CO-d & Develop an object oriented program using multithreading and exception handling for a given problem statement. &  \\
\hline
CO-e & Develop an object-oriented program by using the files and collection framework. &  \\
\hline
\end{longtable}
...
\subsection{Inheritance, Packages \textbackslash{}& Interfaces}
...
\subsection{Exception Handling \textbackslash{}& Multithreading}
...
\item[4d] Define thread, creating threads, multithreading, thread priority \textbackslash{}& synchronization
\end{itemize}
