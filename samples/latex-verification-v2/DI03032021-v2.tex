...
\fancypagestyle{gtupage}{
    ...
    \fancyhead[R]{
        \textbf{\footnotesize w.e.f. 2024-25}\\
...
\begin{document}
\firstpageheader{Engineering}{Diploma}{Information \& Communication Technology}{DI03032021}{Java Programming}


\begin{center}
\begin{tabular}{|l|l|}
\hline
\textbf{w.e.f Academic Year:} & w.e.f. 2024-25 \\
\hline
\textbf{Semester:} & 3$^{rd}$ \\
\hline
...
\hline
\textbf{Prerequisite:} & Basic computer programming concepts: Students should have a foundational understanding of programming principles, including variables, control structures, data types, and basic algorithms. Familiarity with any programming language, such as C or Python, is recommended. \\
\hline
\end{tabular}
\end{center}
...
\hline
1 & Write simple Java programs using basic syntax, data types, and control structures. & R,U,A \\
\hline
